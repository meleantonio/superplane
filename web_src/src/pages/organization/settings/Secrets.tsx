      ...
      <div className="bg-white dark:bg-gray-800 rounded-lg border border-gray-300 dark:border-gray-800 overflow-hidden">
        {sortedSecrets.length > 0 && (
          <div className="px-6 pt-6 pb-4 flex items-center justify-start">
            <Button className="flex items-center" onClick={handleCreateClick}>
              <Icon name="plus" />
              Create Secret
            </Button>
          </div>
        ...
        <div className="px-6 pb-6 min-h-96">
          {sortedSecrets.length === 0 ? (
            <div className="flex min-h-96 flex-col items-center justify-center text-center">
              ...
              <Button className="mt-4 flex items-center" onClick={handleCreateClick}>
                <Icon name="plus" />
                Create Secret
              </Button>
            </div>
            ...
            >
              ...
              <div className="space-y-4">
                ...
                <div className="border-t border-gray-200 dark:border-gray-700 pt-6">
                  ...
                  <Button type="button" variant="outline" size="sm" onClick={addKeyValuePair} className="mt-3 text-xs">
              ...
              <div className="flex justify-start gap-3 mt-6">
                <Button
                  type="submit"
                  color="blue"
                  disabled={createSecretMutation.isPending || !secretName?.trim()}
